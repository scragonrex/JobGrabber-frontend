...
import { Box, Select, MenuItem, IconButton, InputBase, Typography, useMediaQuery, FormControl } from '@mui/material';
...
const Navbar = () => {
  ...
  const [fullName, setFullName] = useState('Abhishek Anand');
